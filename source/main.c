...
//     TestSort ("tests/test_most_duplicates", "output/lomuto.txt",
//               0, 100000, 1000, 1, QuickLomutoSort);
//
//     TestSort ("tests/test_most_duplicates", "output/hoare.txt",
//               0, 100000, 1000, 1, QuickHoareSort);
//
//     TestSort ("tests/test_most_duplicates", "output/thick.txt",
//               0, 100000, 1000, 1, QuickThickSort);
